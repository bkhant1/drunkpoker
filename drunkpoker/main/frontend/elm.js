...
var $author$project$Main$Progressing = {$: 'Progressing'};
...
var $author$project$Main$realInit = _Utils_Tuple2(
	{
		baseUrl: '',
		gameState: {
			gameState: $author$project$Main$Progressing,
...
var $author$project$Main$gameStateFromJsonState = function (jsonState) {
	...
	var makePlayer = F2(
		function (playerId, seatNumber) {
			var _v2 = A2($elm$core$Dict$get, playerId, jsonState.players);
			if (_v2.$ === 'Nothing') {
				return $elm$core$Maybe$Nothing;
			} else {
				var jsonPlayer = _v2.a;
				return $elm$core$Maybe$Just(
					A2(jsonPlayerToPlayer, jsonPlayer, seatNumber));
			}
		});
	var stringSeatPlayerIdToSeatNumberPlayer = function (_v1) {
		var stringSeat = _v1.a;
		var playerId = _v1.b;
		var seatNumber = function () {
			var _v0 = $elm$core$String$toInt(stringSeat);
			if (_v0.$ === 'Just') {
				var result = _v0.a;
				return result;
			} else {
	...
	return A2(
		...
		$author$project$Main$Progressing);
};
